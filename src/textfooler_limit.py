...
def attack(text_ls, true_label, predictor, detector, stop_words_set, word2idx, idx2word, cos_sim,simplify, sim_predictor=None,
    ...
    if true_label != orig_label:
        ...
        for idx, synonyms in synonyms_all:
            ...
            detect_probs = detector(new_texts, simplify, batch_size=batch_size)
            ...
            #new_probs_mask *= (0 == torch.argmax(detect_probs, dim=-1)).data.cpu().numpy()
            #print(1 != torch.argmax(detect_probs, dim=-1))
...
def main():
    ...
    if args.do_simplify:
        ...
        simplify_dict = {'v1': simplifier.simplify, 'v2': simplifier.simplify_v2, 'v3': simplifier.simplify_v3,
                         'perturb': simplifier.perturb_v1, 'perturb_v2': simplifier.perturb_v2,
                         'perturb_v3': simplifier.perturb_v3,
                         'perturb_v4': simplifier.perturb_v4, 'perturb_v5': simplifier.perturb_v5,
                         'perturb_v6': simplifier.perturb_v6, 'perturb_v7': simplifier.perturb_v7,
                         'random_v2': simplifier.random_simplify_v2, 'random_v3': simplifier.random_simplify_v3,
                         'random_v4': simplifier.random_simplify_v4,
                         'v4': simplifier.simplify_v4, 'v5': simplifier.simplify_v5, 'v6': simplifier.simplify_v6,
                         'v3_new': simplifier.simplify_v3_new, 'v4_new': simplifier.simplify_v4_new,
                         'freq_v1': simplifier.freq_subs_v1, 'freq_v2': simplifier.freq_subs_v2, 'freq_v3': simplifier.freq_subs_v3,
                         'freq_v4': simplifier.freq_subs_v4, 'freq_v5': simplifier.freq_subs_v5, 'freq_v6': simplifier.freq_subs_v6,
                         'random_freq_v1':simplifier.random_freq_v1, 'random_freq_v2':simplifier.random_freq_v2,
                         'random_freq_v3':simplifier.random_freq_v3, 'random_freq_v4':simplifier.random_freq_v4}
    ...
    detector_model = NLI_infer_BERT(args.detector_model_path, nclasses=args.nclasses, max_seq_length=args.max_seq_length)
